...
impl Memory {
    ...
    pub fn new_from_elf(elf_data: &[u8]) -> Result<Self> {
        // Initialize our stack 2 * size bytes from the top of the address space to prevent
        // stack pointer overflow.
        //
        // TODO: Should stack size should be configurable?
        let mut memory = Self::new(Ptr32(0xFFFF8000), 16384);
